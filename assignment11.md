...
**Môn:** AICB-P1 — AI Agent Development**Hình thức:** **Cá nhân** (1 người / 1 MSSV)**Hạn nộp:** Thứ sáu **7/8**, **23:59 giờ Việt Nam (ICT)****Cách nộp:** `[SUBMISSION.md](SUBMISSION.md)`
...
**Thứ tự đúng:** mở file → làm TODO → rồi mới chạy lệnh kiểm tra.**Đừng** chạy `main.py --part 2` khi chưa implement gì.
